...
class Stk < ApplicationRecord
  class << self
    def create_stk(response, phone, status)
      Stk.create(
    ...
    def process_request_for_update(request, statusRes, resultCode)
    ...
    def update_success_stk(mpesaReceiptNumber, merchantRequestID, checkoutRequestID, resultCode, resultDesc, statusRes)
      @stk = {
    ...
    def update_pending_with_merchant_request_id(transaction)
