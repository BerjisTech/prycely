...
ActiveRecord::Schema.define(version: 20_220_410_125_506) do
  ...
  create_table 'group_assets', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    t.text 'name'
    t.text 'description'
    t.uuid 'group_id'
  ...
  create_table 'loancategories', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6, null: false
    t.string 'pegged_to'
    t.integer 'membership_durantion_requirement'
    t.integer 'approvals', default: 4
  end
  ...
  create_table 'ncbas', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
  end
  ...
  create_table 'wises', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
  end
