...
class RequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update request" do
    patch request_url(@request), params: { request: { accept: @request.accept, account_id: @request.account_id, emai: @request.emai, group_id: @request.group_id, user_id: @request.user_id } }
