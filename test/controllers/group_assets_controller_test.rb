...
class GroupAssetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_asset" do
    assert_difference('GroupAsset.count') do
      post group_assets_url, params: { group_asset: { date_bought: @group_asset.date_bought, date_sold: @group_asset.date_sold, description: @group_asset.description, group_id: @group_asset.group_id, name: @group_asset.name, price: @group_asset.price, user_id: @group_asset.user_id } }
    end
  ...
  test "should update group_asset" do
    patch group_asset_url(@group_asset), params: { group_asset: { date_bought: @group_asset.date_bought, date_sold: @group_asset.date_sold, description: @group_asset.description, group_id: @group_asset.group_id, name: @group_asset.name, price: @group_asset.price, user_id: @group_asset.user_id } }
