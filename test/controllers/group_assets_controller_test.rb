  ...
  test 'should create group_asset' do
    assert_difference('GroupAsset.count') do
      post group_assets_url,
           params: { group_asset: { added_by: @group_asset.added_by, date_bought: @group_asset.date_bought,
                                    date_sold: @group_asset.date_sold, description: @group_asset.description, group_id: @group_asset.group_id, name: @group_asset.name, price: @group_asset.price } }
    end
