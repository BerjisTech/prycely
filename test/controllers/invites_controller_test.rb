...
class InvitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update invite" do
    patch invite_url(@invite), params: { invite: { group_id: @invite.group_id, invite_email: @invite.invite_email, invite_key: @invite.invite_key, max_redeem: @invite.max_redeem } }
