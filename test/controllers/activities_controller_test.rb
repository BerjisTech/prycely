...
class ActivitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update activity" do
    patch activity_url(@activity), params: { activity: { created_by: @activity.created_by, date: @activity.date, description: @activity.description, fine: @activity.fine, group_id: @activity.group_id, host: @activity.host, host_contact: @activity.host_contact, price: @activity.price, title: @activity.title } }
