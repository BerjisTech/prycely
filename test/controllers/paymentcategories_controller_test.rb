...
class PaymentcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update paymentcategory" do
    patch paymentcategory_url(@paymentcategory), params: { paymentcategory: { created_by: @paymentcategory.created_by, group_id: @paymentcategory.group_id, name: @paymentcategory.name, type: @paymentcategory.type } }
