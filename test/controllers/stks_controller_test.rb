...
class StksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update stk" do
    patch stk_url(@stk), params: { stk: { checkout_request_id: @stk.checkout_request_id, custom_message: @stk.custom_message, merchant_request_id: @stk.merchant_request_id, phone: @stk.phone, response_code: @stk.response_code, response_description: @stk.response_description, response_result_code: @stk.response_result_code, response_result_description: @stk.response_result_description, status: @stk.status, transaction_reference: @stk.transaction_reference } }
